...
//data: 19/08/2024
//exercicio #05 proposto em aula
//objetivo: faça um programa que recebe três notas inteiras e imprime a média DAS DUAS MAIORES NOTAS. Além disso, imprima o status do aluno.
